...
LOG_DIR=$HOME/pytorch_experiments/refineloc/beta_generator_study_untrimmednet_activitynet_v1-2
DEVICE=cuda:0
CONFIG_TYPE=beta_generator_study_untrimmednet_activitynet_v1-2
